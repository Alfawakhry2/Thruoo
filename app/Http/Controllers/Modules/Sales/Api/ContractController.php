...
class ContractController extends Controller
{
     ...
     */
    public function index($moduleId, $leadId): JsonResponse
    {
     ...
     */
    public function store(Request $request, $moduleId, $leadId): JsonResponse
    {
        $lead = Lead::where('module_id', $moduleId)->find($leadId);
     ...
     */
    public function show($moduleId, $leadId, $contractId): JsonResponse
    {
        $lead = Lead::where('module_id', $moduleId)->find($leadId);
     ...
     * Update a contract
     */
    public function update(Request $request, $moduleId, $leadId, $contractId): JsonResponse
    {
        $lead = Lead::where('module_id', $moduleId)->find($leadId);
     ...
     * Delete a contract
     */
    public function destroy($moduleId, $leadId, $contractId): JsonResponse
    {
        $lead = Lead::where('module_id', $moduleId)->find($leadId);

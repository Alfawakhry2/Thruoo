...
class UserController extends Controller
{
    ...
    public function store($moduleId, Request $request): JsonResponse
    {
        ...
        // Handle additional fields (store in preferences or create additional model)
        $preferences = [
     ...
     * Get a specific user
     */
    public function show($moduleId, $userId): JsonResponse
    {
        $currentUser = Auth::user();

        $user = User::with(['roles', 'inviter'])->find($userId);
        ...
        return response()->json([
            ...
            'data' => [
                ...
                'branch_ids' => $preferences['branch_ids'] ?? [],
     ...
     * Update a user
     */
    public function update(Request $request, $moduleId, $userId): JsonResponse
    {
        $currentUser = Auth::user();
     ...
     * Delete a user
     */
    public function destroy($moduleId, $userId): JsonResponse
    {
        $currentUser = Auth::user();

...
class TeamController extends Controller
{
     ...
     * Create a new team
     */
    public function store($moduleId, StoreTeamRequest $request): JsonResponse
    {
        // Verify module exists
        $module = Module::find($moduleId);
        if (!$module) {
     ...
     * Get a specific team
     */
    public function show($moduleId, $teamId): JsonResponse
    {
        // Verify module exists
        $module = Module::find($moduleId);
        if (!$module) {
     ...
     * Update a team
     */
    public function update($moduleId, UpdateTeamRequest $request, $teamId): JsonResponse
    {
        // Verify module exists
        $module = Module::find($moduleId);
        if (!$module) {
        ...
        $team = Team::where('module_id', $moduleId)->find($teamId);
     ...
     * Delete a team
     */
    public function destroy($moduleId, $teamId): JsonResponse
    {
        // Verify module exists
        $module = Module::find($moduleId);
        if (!$module) {
     ...
     * Add member to team
     */
    public function addMember($moduleId, $teamId, Request $request): JsonResponse
    {
        // Verify module exists
        $module = Module::find($moduleId);
        if (!$module) {
     ...
     */
    public function removeMember($moduleId, $teamId, $userId): JsonResponse
    {
        // Verify module exists
        $module = Module::find($moduleId);
        if (!$module) {
     ...
     */
    public function performance($moduleId, $teamId, Request $request): JsonResponse
    {
        // Verify module exists
        $module = Module::find($moduleId);
        if (!$module) {
     ...
     */
    public function myTeams($moduleId): JsonResponse
    {
        // Verify module exists
        $module = Module::find($moduleId);
        if (!$module) {

...
class ContractTemplateController extends Controller
{
    ...
    public function show($moduleId, $templateId): JsonResponse
    {
    ...
    public function update($moduleId, Request $request, $templateId): JsonResponse
    {
        $template = ContractTemplate::where('module_id', $moduleId)->find($templateId);
    ...
    public function destroy($moduleId, $templateId): JsonResponse
    {
        $template = ContractTemplate::where('module_id', $moduleId)->find($templateId);

...
class RolePermissionController extends Controller
{
     ...
     */
    public function getRoles($moduleId): JsonResponse
    {
        $user = Auth::user();
     ...
     */
    public function getPermissions($moduleId): JsonResponse
    {
        $user = Auth::user();
     ...
     */
    public function getRole($moduleId, $roleId): JsonResponse
    {
        $user = Auth::user();
     ...
     */
    public function updateRolePermissions($moduleId, Request $request, $roleId): JsonResponse
    {
        $user = Auth::user();
     ...
     */
    public function getRoleAccessDetails($moduleId, $roleName): JsonResponse
    {
        $user = Auth::user();
     ...
     */
    public function bulkUpdatePermissions($moduleId, Request $request): JsonResponse
    {
        $user = Auth::user();
     ...
     */
    public function togglePermission($moduleId, Request $request): JsonResponse
    {
        $user = Auth::user();

...
class ProductVariantController extends Controller
{
     ...
     */
    public function index($moduleId, $productId, Request $request): JsonResponse
    {
     ...
     * Create variant
     */
    public function store($moduleId, $productId, Request $request): JsonResponse
    {
        $module = Module::find($moduleId);
        if (!$module) {
            return response()->json(['success' => false, 'message' => 'Module not found'], 404);
     ...
     * Get single variant
     */
    public function show($moduleId, $productId, $variantId): JsonResponse
    {
        $module = Module::find($moduleId);
        if (!$module) {
            return response()->json(['success' => false, 'message' => 'Module not found'], 404);
     ...
     * Update variant
     */
    public function update($moduleId, $productId, Request $request, $variantId): JsonResponse
    {
        $module = Module::find($moduleId);
        if (!$module) {
            return response()->json(['success' => false, 'message' => 'Module not found'], 404);
     ...
     * Delete variant
     */
    public function destroy($moduleId, $productId, $variantId): JsonResponse
    {
        $module = Module::find($moduleId);
        if (!$module) {
            return response()->json(['success' => false, 'message' => 'Module not found'], 404);
     ...
     */
    public function toggleStatus($moduleId, $productId, $variantId): JsonResponse
    {
        $module = Module::find($moduleId);
        if (!$module) {
            return response()->json(['success' => false, 'message' => 'Module not found'], 404);

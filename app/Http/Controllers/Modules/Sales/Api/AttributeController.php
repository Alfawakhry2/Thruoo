...
class AttributeController extends Controller
{
     ...
     */
    public function show($moduleId, $attributeId): JsonResponse
    {
        $module = Module::find($moduleId);
        if (!$module) {
            return response()->json(['success' => false, 'message' => 'Module not found'], 404);
     ...
     * Update attribute
     */
    public function update($moduleId, Request $request, $attributeId): JsonResponse
    {
        $module = Module::find($moduleId);
        if (!$module) {
            return response()->json(['success' => false, 'message' => 'Module not found'], 404);
        ...
        $attribute = Attribute::where('module_id', $moduleId)->find($attributeId);
        if (!$attribute) {
            return response()->json([
                'success' => false,
                'message' => 'Attribute not found',
     ...
     * Delete attribute
     */
    public function destroy($moduleId, $attributeId): JsonResponse
    {
        $module = Module::find($moduleId);
        if (!$module) {
            return response()->json(['success' => false, 'message' => 'Module not found'], 404);
     ...
     */
    public function addValue($moduleId, $attributeId, Request $request): JsonResponse
    {
        $module = Module::find($moduleId);
        if (!$module) {
            return response()->json(['success' => false, 'message' => 'Module not found'], 404);
     ...
     */
    public function updateValue($moduleId, $attributeId, $valueId, Request $request): JsonResponse
    {
        $module = Module::find($moduleId);
        if (!$module) {
            return response()->json(['success' => false, 'message' => 'Module not found'], 404);
     ...
     */
    public function deleteValue($moduleId, $attributeId, $valueId): JsonResponse
    {
        $module = Module::find($moduleId);
        if (!$module) {
            return response()->json(['success' => false, 'message' => 'Module not found'], 404);
